...
router.get('/wallet', auth_1.authenticateToken, paymentController_1.getWalletOverview);
...
router.post('/verify-job-posting', auth_1.authenticateToken, paymentController_1.verifyJobPostingPayment);
